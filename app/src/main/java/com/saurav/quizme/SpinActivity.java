...
import com.saurav.quizme.SpinWheel.LuckyItem;
import com.saurav.quizme.SpinWheel.LuckyWheelView;
import com.saurav.quizme.databinding.ActivitySpinBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.spinBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Random r = new Random();
                int randamNumber = r.nextInt(8);

                binding.wheelview.startLuckyWheelWithTargetIndex(randamNumber);
            }
        });
    ...
    void updateCash(int index){
        ...
        database
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(SpinActivity.this, "Coins added in account", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
